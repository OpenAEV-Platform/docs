...
| openbas.xtm.hub.collector.enable                       | OPENBAS_XTM_HUB_COLLECTOR_ENABLE                      | false                                | Enables the XTM Hub connectivity collector                          |
| openbas.xtm.hub.collector.id                           | OPENBAS_XTM_HUB_COLLECTOR_ID                          | b402f1f5-29ba-4ee3-b366-f0467754cf4e | Identifier of the XTM Hub connectivity collector                    |
| openbas.xtm.hub.collector.connectivity-check-internval | OPENBAS_XTM_HUB_COLLECTOR_CONNECTIVITY_CHECK_INTERVAL | 1 hour in milliseconds               | Interval at which the connectivity with XTM Hub is checked          |
