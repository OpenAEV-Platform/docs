...
| executor.paloaltocortex.windows-script-id                     | EXECUTOR_PALOALTOCORTEX_WINDOWS_SCRIPT_ID                     |               | Uid of the OpenAEV Palo Alto Cortex Windows script                                                                                                                    |
| executor.paloaltocortex.unix-script-id                        | EXECUTOR_PALOALTOCORTEX_UNIX_SCRIPT_ID                        |               | Uid of the OpenAEV Palo Alto Cortex Unix script                                                                                                                       |
